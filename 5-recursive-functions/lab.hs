...
main = do
  ...
  assert ((doubleSecond [8, 7, 6, 5]) == [8, 14, 6, 10]) "doubleSecond is wrong"
  assert ((sumDigits [8,14,6,10]) == 20) "sumDigits is wrong"
  assert ((sumDigits [3,9,4,15,8]) == 30) "sumDigits is wrong"
  assert (isValid 4012888888881881) "isValid is wrong"
  assert ((isValid 4012888888881891) == False) "isValid is wrong"
